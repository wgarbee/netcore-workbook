...
dotnet restore "$DEPLOYMENT_SOURCE/Lesson08/StartOfLesson/BaseProject/BaseProject.csproj"
exitWithMessageOnError "dotnet restore failed"

# 2. Build and publish
dotnet publish "$DEPLOYMENT_SOURCE/Lesson08/StartOfLesson/BaseProject/BaseProject.csproj" --output "$DEPLOYMENT_TEMP" --configuration Release
